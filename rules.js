...
function play() {
	...
	if(index == -1 || board_state[index] != -1){
		alert("Invalid move");
	}else{
		...
		if((board_state[0] == board_state[1] && board_state[1] == board_state[2] && board_state[2] != -1) || (board_state[3] == board_state[4] && board_state[5] == board_state[4] && board_state[4] != -1) || (board_state[6] == board_state[7] && board_state[7] == board_state[8] && board_state[8] != -1) || (board_state[0] == board_state[3] && board_state[3] == board_state[6] && board_state[6] != -1) || (board_state[1] == board_state[4] && board_state[4] == board_state[7] && board_state[7] != -1) || (board_state[2] == board_state[5] && board_state[5] == board_state[8] && board_state[8] != -1) ||
		(board_state[0] == board_state[4] && board_state[4] == board_state[8] && board_state[8] != -1) || (board_state[2] == board_state[4] && board_state[4] == board_state[6] && board_state[6] != -1)){
